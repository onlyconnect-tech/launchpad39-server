...
ClientController.prototype.subscribeByTopic = function (topicName) {
  this.client.subscribe(topicName);
};

ClientController.prototype.publishByTopic = function (topicName, message) {
